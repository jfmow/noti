    ...
    <>
      ...
      <div className="w-full text-zinc-800">
        ...
        <div className="w-full min-h-screen  relative ">
          ...
          <nav className="p-3 fixed top-0 bg-zinc-50 shadow-lg text-zinc-700 items-center grid sm:grid-cols-3 min-h-[60px] z-[50] w-full ">
          ...
          <div className="inline-flex justify-center items-center w-full h-[100dvh] pt-[90px] sm:pt-0">
            <div className="flex flex-col justify-center items-center w-full max-w-[1200px] px-5">
              ...
              <div className="py-6 mt-4 flex items-center justify-center gap-6 flex-row mb-12 w-full">
                ...
                <Link href="/page?edit=previewwelcome0" className="px-4 py-2 text-md bg-zinc-100 text-zinc-800 rounded-md font-medium hover:bg-zinc-200">
                  View demo
                </Link>
              </div>
