  ...
  return (
    <div className={styles.CompBanner}>
      ...
      <div className={styles.CompBanner_logos}>
        <Link href='https://github.com/jfmow/noti'><img src='/Brand-assets/GitHub_Logo.png' /></Link>
        <Link href='https://jamesmowat.com'><img src='/Brand-assets/jamesmowat.svg' /></Link>
      </div>
    </div>
  )
}
