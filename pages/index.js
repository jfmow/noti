...
export default function Home() {
  return (
    <>
      ...
      <div className="w-full relative bg-zinc-50 h-screen overflow-hidden">
        ...
        <nav className="px-5 py-3 sm:py-0 text-black items-center grid sm:grid-cols-3 sticky top-0 left-0 right-0 h-[60px] z-50 w-full border-b bg-zinc-50">
          ...
          <div className="w-full h-full items-center justify-end hidden sm:flex">
            <Link href={"/auth/signup"} className="py-3 px-4 bg-zinc-200 hover:bg-zinc-300 rounded-lg transition-all font-semibold min-w-[120px]">
              Get Started
            </Link>
          </div>
        </nav>
        ...
        <div className="h-screen oveflow-hidden w-full relative bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 flex justify-center background-animate">
          <div className="max-w-[1401px] overflow-hidden">
            <div className=" text-zinc-800 mx-auto flex max-w-[980px] px-5 flex-col items-center gap-2 py-8 md:py-12 md:pb-8 lg:py-24 lg:pb-20">
              <Link href={"/page/rzz50e2mnhgwof2"} className={"py-1 text-sm font-medium px-4 rounded-[99999px] bg-zinc-200"}>🎉 | Welcome to note! Note's for you</Link>
              ...
              <div className="flex items-center jsutify-center gap-5 flex-wrap mt-3">
                <Link href={"/auth/signup"} className={"inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-black text-zinc-300 hover:bg-black/90 h-10 px-4 py-2"}>Get Started</Link>
                <Link href={"/page/rzz50e2mnhgwof2"} className={"inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-none border shadow-md text-zinc-300 hover:bg-black/10 h-10 px-4 py-2"}>Explore the demo</Link>
              </div>
            </div>
