      ...
      switch (theme) {
        ...
        case 'pink':
          const variables3 = {
            ...
            '--main_btn_color': '#00bcd4',
            '--main_btn_color_action': '#15cce4',
            '--big_button_border': 'hsla(240,3%,79%,.48)',
            '--big_button_text': '#707684',
            '--big_button_background': '#fff',
            '--big_button_background_hover': '#000',
            '--big_button_border_hover_alt': '#b7b7b7',
            ...
            '--color-FFF7EA': '#fff7ea',
            '--color-e9e9e9': '#ef91ce',
            '--color-rgba555347035': 'rgba(55,53,47,.35)',
            '--color-rgb228228228': '#e4e4e4',
            '--color-f4f4f4': '#f4f4f4',
            '--color-19171199': '#19171199',
            '--color-rgb245245245': '#f5f5f5',
            '--color-cecece1a': '#cecece1a',
            '--color-ababab6e': '#ababab6e',
            '--color-rgb515151': '#333',
            '--color-767676': '#767676',
            '--color-4e4e4e': '#4e4e4e',
            '--color-526f8f': '#526f8f',
            '--color-rgba255255255035': 'hsla(0,0%,100%,.35)',
            '--color-242424': '#242424',
            '--color-rgb343434': '#222',
            '--color-ffffff99': '#ffffff99',
            '--color-rgb000': '#000',
            ...
            '--color-CE4343': '#ce4343',
            '--color-dedede': '#dedede',
            '--color-rgb52228255': '#34e4ff',
            '--color-rgb0225255': '#00e1ff',
            '--color-9f86ff': '#9f86ff',
            '--color-8f8f8f': '#8f8f8f',
            '--color-607d8b': '#607d8b',
            '--color-b1b1b1': '#e88ec8',
            '--color-ff6c6c': '#ff6c6c',
            '--color-rgba00005': 'rgba(0,0,0,.5)',
            '--color-ececec': '#ececec',
            '--color-ffffff57': '#ffffff57',
            '--color-rgb255255255': '#fff',
            '--color-rgb25521699': '#ffd863',
            '--color-0d2342': '#0d2342',
            '--color-00000000': '#00000000',
            '--color-e4e4e4': '#e4e4e4',
            '--color-2196F300': '#2196f300',
            '--color-2196F3': '#2196f3',
            '--color-rgb0rgb000': '#000',
            '--color-a9a9a9': '#a9a9a9',
            '--color-ff5555': '#f55',
            '--color-0071e2': '#0071e2',
            '--color-rgba00002': 'rgba(0,0,0,.2)',
            '--color-fff0': '#fff0',
            '--color-9E9E9E': '#9e9e9e',
            '--color-607D8B': '#607d8b',
            '--color-0b0b0b': '#0b0b0b',
            ...
            '--color-1899d6': '#1899d6',
            '--color-1cb0f6': '#1cb0f6',
            '--color-rgba2552552550': 'hsla(0,0%,100%,0)',
            '--color-rgba20120120448': 'hsla(240,3%,79%,.48)',
            '--color-e8e8e8': '#e8e8e8',
            '--color-707684': '#fff',
            '--color-ff2d2d': '#ff2d2d',
            '--color-fff': '#fff',
            ...
            '--color-353535': '#353535',
            '--color-1c1c1c': '#1c1c1c',
            '--color-rgb149149149': '#959595',
            '--color-d3d3d3': '#d3d3d3'


          };
          const r23 = document.documentElement.style;

          for (const variable in variables3) {
            r23.setProperty(variable, variables3[variable]);
          }
          break;
        default:
          break;
