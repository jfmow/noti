        ...
        switch (theme) {
          ...
          case 'navy blue':
            vars = {
              ...
              '--modal_text_color': '#fff',
              '--popup_background': '#414b59',
              '--modal_button_text': '#707684',
              '--modal_close_button_hover': '#ebebeb',
              '--popup_button_bg': '#353b44',
              '--modal_button_border': 'none',
              '--popup_button_bg_hover': '#282d34',
              '--modal_button_text_hover': '#fff',
          ...
          case 'pro pink':
            vars = {
              ...
              '--modal_text_color': '#fff',
              '--popup_background': '#d09bc9',
              '--modal_button_text': '#ffffff',
              '--modal_close_button_hover': '#ebebeb',
              '--popup_button_bg': '#d06ec2',
              '--modal_button_border': 'none',
              '--popup_button_bg_hover': '#b461a8',
          ...
          case 'relax orange':
            vars = {
              ...
              '--page_list_item_fillcolor': '#ffffffcf',
              '--modal_text_color': '#fff',
              '--popup_background': '#eb9a72',
              '--modal_button_text': '#ffffff',
              '--modal_close_button_hover': '#ebebeb',
              '--popup_button_bg': '#d87c4f',
              '--modal_border_color': '#a1684c',
              '--modal_button_border': 'none',
              '--popup_button_bg_hover': '#d67445',
              '--modal_button_svg': '#fff',
          ...
          case 'pro dark':
            vars = {
              ...
              '--page_list_item_fillcolor': '#ffffff99',
              '--modal_text_color': '#fff',
              '--popup_background': '#111111',
              '--modal_button_text': '#707684',
              '--modal_close_button_hover': '#ebebeb',
              '--popup_button_bg': '#292929',
              '--modal_button_border': 'none',
              '--popup_button_bg_hover': '#2b2b2b',
              '--modal_button_text_hover': '#fff',
          ...
          case 'mid light':
            vars = {
              ...
              '--popup_button_bg': '#eaeaea',
              '--modal_button_border': 'none',
              '--popup_button_bg_hover': '#000000',
              '--modal_button_text_hover': '#fff',
          ...
          case 'cool gray':
            vars = {
              ...
              '--modal_text_color': '#000',
              '--modal_button_svg': '#707684',
              '--popup_background': '#e7e7e7',
              '--modal_button_text': '#707684',
              '--modal_close_button_hover': '#000000',
              '--popup_button_bg': '#ffffff',
              '--modal_button_border': 'none',
              '--popup_button_bg_hover': '#cdcdcd',
