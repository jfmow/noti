      ...
      <div className={styles.container}>
        <div className={styles.auth_container}>
          ...
          <form className={styles.auth_form} onSubmit={(e) => loginNormal(e)}>
            ...
            <SubmitButton data-track-event aria-label="Login button" disabled={loginRunning} type="submit">
              {loginRunning ? (<>
          ...
          <SubmitButton data-track-event alt aria-label="Github login button" disabled={loginRunning} type="button" onClick={() => OAuthLogin('github')}>
          ...
          <SubmitButton data-track-event alt aria-label="Twitch login button" disabled={loginRunning} type="button" onClick={() => OAuthLogin('twitch')}>
          ...
          <Link data-track-event style={{ textAlign: 'center' }} href={'/auth/signup'}>Signup</Link>
        </div>
      </div>
