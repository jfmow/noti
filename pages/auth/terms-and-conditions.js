    ...
    return (
        <div className={legal.container}>
            <ol>
                ...
                <p>These Terms of Service ("Terms") govern your use of the note creation and storage website ("the Website") provided by jamesmowat.com ("we," "us," or "our"). By accessing or using the Website, you agree to be bound by these Terms. If you do not agree with these Terms, you must not use the Website.</p>
