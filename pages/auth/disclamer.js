...
export default function pp() {
    async function update() {
        await pb.collection('users').update(pb.authStore.model.id, { seen12hourwarning: true })
    }
    return (
        <div className={legal.container}>
            <h1>To continue to use this app please read this then click this button: <button onClick={update}>Dismiss 12 hour warning</button></h1>
            ...
            <ol>
                ...
                <h2>*** The database now resets every 12 hours so any data uploaded or saved will be deleted after 12 hours ***
                </h2>
                Dear User,
