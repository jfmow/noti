        ...
        try {
            const response = await toast.promise(
                pb.collection('users').requestPasswordReset(email),
                {
                    ...
                    success: 'Reset email sent successfuly. 👌',
        ...
        <div className={styles.login}>
            <div className={styles.card}>
                ...
                <form onSubmit={auth}>
                    ...
                    <p className={styles.signup} style={{paddingTop: "1em"}}>If you have an account with us you will receive an email to reset your password</p>
