                ...
                <div className={styles.auth_container}>
                    ...
                    <form className={styles.auth_form} onSubmit={(e) => loginNormal(e)}>
                        <div className={styles.auth_formgroup}>
                            ...
                            <input type="email" id="email" name="email" placeholder="me@example.com" required="" onChange={(e) => setEmail(e.target.value)} />
                    ...
                    <div className={styles.oauth2}>
                        ...
                        <div className={styles.oauth2_btns}>
                            <button disabled={loginRunning} type="button" onClick={() => OAuthLogin('github')} className={styles.github_btn}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
