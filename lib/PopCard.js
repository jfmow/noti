...
export function PopCardsGlobalButton({ click, style, classname, children }) {
    return (
        <button style={style} className={`${styles.pagebtn} ${styles.pagebtn_dark} ${classname}`} type="button" onClick={click}>
            {children}
        </button >
    )
}