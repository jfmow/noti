...
export function TabGroup({ ...props }) {
    ...
    return (
        <>
            {visible && (
                <div className="fixed top-0 left-0 bg-[var(--popupBackground)] shadow z-[11] border rounded-lg flex flex-col items-center w-[400px] min-h[200px] text-[var(--modalTextColor)] overflow-hidden max-h-[50dvh] " ref={tabgroupRef} {...props}>
                    {props.children}
                </div>
            )}
        </>
