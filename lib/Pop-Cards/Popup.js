                ...
                <>
                    {ReactDom.createPortal(
                        <>
                            ...
                            }} ref={popUpRef} className="fixed bg-[var(--popupBackground)] shadow-sm z-[16] border rounded-lg p-[1.5rem] flex flex-col items-center w-fit min-w-[200px] min-h-[200px] h-fit text-[var(--modalTextColor)] [&>h1]:text-[18px]" {...props}>
                                {props.children}
                            </div>
                        </>,
                        document.body
