...
export function DropDownTrigger({ hover, fullw, afterTrigger, children }) {
    ...
    return (
        <div ref={triggerRef} onClick={() => {
            ...
            if (afterTrigger !== null || afterTrigger !== undefined) {
                afterTrigger()
            }
        }} className={`flex items-center justify-center  h-fit ${fullw ? "w-full" : "w-fit"}`}>
            {children}
        </div>
    )
}
                ...
                <>
                    {createPortal(
                        <>
                            ...
                            <div ref={dropDownRef} className="fixed flex flex-col w-[230px] bg-[var(--popupBackground)] z-[11] shadow-lg rounded-lg">
                                {children}
                            </div>
                        </>,
                        document.body
...
export function DropDownItem({ className, ...props }) {
    return (
        <div className={`flex items-center px-[8px] py-[6px] text-[var(--modalTextColor)] [&>svg]:w-4 [&>svg]:h-4 [&>svg]:mr-2 [&>svg]:flex cursor-pointer hover:bg-[var(--popupButtonBg)] rounded ${className}`} {...props}>
            {props.children}
        </div>
    )
}
    ...
    return (
        <>
            {visible && (
                <>
                    {createPortal(
                        <div ref={dropDownRef2} className="fixed flex flex-col w-[230px] bg-[var(--popupBackground)] z-[18] shadow-lg rounded-lg">
                            {children}
                        </div>,
                        document.body
                    )}
