        ...
        <SettingsPopoverContext.Provider value={{ rerenderPage, pb }}>
            <>
                ...
                {popoverOpen ? (
                    <>
                        {createPortal(
                            <div onClick={() => setPopoverOpen(false)} className="overflow-hidden fixed z-[12] top-0 left-0 right-0 bottom-0 h-[100svh] w-full bg-zinc-800/80 backdrop-blur-sm flex items-center justify-center">
