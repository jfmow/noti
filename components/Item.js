...
export default function PageList() {
  ...
  return (
    ...
    <>
      <div ref={shrinkcontainerRef} className=" sm:w-[300px] w-full sm:z-[1] z-[8] fixed top-0 left-0 right-0 bottom-0 overflow-hidden sm:overflow-auto sm:relative h-[100dvh]">
