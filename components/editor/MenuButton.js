        ...
        <>
            ...
            <div className={styles.buttonlabel}>
                ...
                <PopCardDropMenu event={popUpClickEventPageOptions} className={styles.title_buttons_btn}>
                    ...
                    <PopCardDropMenuSection onHover={() => {
                        ...
                        <PopCardDropMenuSectionItem
                            onClick={() => setSharePageInfo(!sharePageInfo)} onHover={() => setShowPageInfo(false)} >
                        ...
                        <PopCardDropMenuSectionItem onClick={(e) => handleExportPageToMarkdown(e)} onHover={() => setShowPageInfo(false)}>
                        ...
                        <PopCardDropMenuSectionItem onClick={() => setShowPageInfo(!showPageInfo)}>
