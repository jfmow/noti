...
export default function TabBar({ pb, page, plVisible, setplVisible }) {
    ...
    return (
        <>
            {!tabBarHidden && (
                <div className={styles.tabbar} style={!plVisible ? { width: '100%', animationPlayState: 'running', animationName: styles.comein } : { animationPlayState: 'running', animationName: styles.goout }}>
                    {!plVisible && (
