        ...
        <>
            ...
            <PopUpCardDropMenuStaticPos animationOrgin={'bottom left'} mobilepos={{
                ...
                <PopUpCardDropMenuSection>
                    <div>
                        <PopUpCardDropMenuSectionItem onClick={() => setUserInfoModal(true)} onMouseLeave={() => setUserInfoModal(false)}>
                            ...
                            Account details
                            {userInfoModal && (
                                <PopDropMenuStatic close={() => setUserInfoModal(false)} style={{ width: '200px', minHeight: '100px', position: 'absolute', zIndex: '999', right: `-190px`, top: '-90px' }} >
                                    <PopUpCardDropMenuSectionTitle>
                                        Details
                                    </PopUpCardDropMenuSectionTitle>
                                    <PopUpCardDropMenuSection>
                    ...
                    <div>
                        <PopUpCardDropMenuSectionItem onClick={() => setUsageModal(true)} onMouseLeave={() => setUsageModal(false)}>
                            ...
                            Usage
                            {usageModal && (
                                <PopDropMenuStatic close={() => setUsageModal(false)} style={{ width: '200px', minHeight: '100px', position: 'absolute', zIndex: '999', right: `-190px`, top: '-0px' }}>
                                    <PopUpCardDropMenuSectionTitle>
                                        Usage
                                    </PopUpCardDropMenuSectionTitle>
                                    <PopUpCardDropMenuSection>
