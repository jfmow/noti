...
export default function UserOptions({ clss }) {
    return (
        <>
            <div className={`${"absolute top-0 z-[2] w-full sm:w-full grid grid-cols-[1fr_3fr_1fr] items-center justify-items-center justify-between px-4 py-2 h-[70px] text-[var(--userOptionText)] shadow bg-[var(--background)]"} ${clss}`}>
