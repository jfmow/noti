                    ...
                    embed: {
                        ...
                        config: {
                            services: {
                                ...
                                customDocs: {
                                    regex: /https?:\/\/notidb\.suddsy\.dev\/api\/files\/videos\/([^\/\?\&]*)\/([^\/\?\&]*)\.docx/,
                                    embedUrl: 'https://docs.google.com/viewerng/viewer?url=https://notidb.suddsy.dev/api/files/videos/<%= remote_id %>.docx&embedded=true',
                                    html: "<iframe  width='100%' height='500' style='border: none;'></iframe>",
                                    height: 300,
                                    width: 600,
                                    id: (groups) => groups.join('/')
